...
class SpotDIPy:
    ...
    def reconstructor(self, alpha=1.0, beta=1.0, gamma=1.0, delta=1.0, lmbd=1.0, lmbd2=0.0, maxiter=100, tol=1e-10, disp=True,
                      cpcs=None):
    ...
    def grid_search_run(self, fpmg):
        ...
        self.minimize(x0s=x0s, minx0s=minx0s, maxx0s=maxx0s, maxiter=self.optp_gs['maxiter'], tol=self.optp_gs['tol'],
                      alpha=self.optp_gs['alpha'], beta=self.optp_gs['beta'], gamma=self.optp_gs['gamma'], delta=self.optp_gs['delta'],
                      lmbd=self.optp_gs['lmbd'], lmbd2=self.optp_gs['lmbd2'], cpcs=cpcs, disp=False)
