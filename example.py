...
# data_path: Path to the directory containing the required data files. If set to None, an "exotic_ld_data" folder will be created, and the necessary files will be downloaded from the internet into this folder.
